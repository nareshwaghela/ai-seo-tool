...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    keyword = st.text_input("Keyword ", placeholder="e.g. best CRM software")
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    topic = st.text_input("Topic / Niche d", placeholder="e.g. project management software")
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    uploaded = st.file_uploader("Image upload ", type=["png", "jpg", "jpeg"])
